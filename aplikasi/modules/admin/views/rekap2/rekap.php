    <div class="row">
    <div class="col-lg-12" >
    <h3>Rekap Data Per Fakultas (Sudah Verifikasi)</h3>
        <table style="width:100%;" class='table' id='rekapfak'>
            ...
            <tbody>
            <?php $no=1; $jump2 = 0; $jumw2 = 0; $jump3 = 0; $jumw3 = 0;
            ...
            <?php $no++; $jump2+=$p2; $jumw2+=$w2; $jump3+=$p3; $jumw3+=$w3;}?>
            <tr>
                <td>11</td>
                <td>Belum Memilih</td>
                <td><?php echo $p2 = $allpria['nomayor']['2']['jumlah'] - $jump2;?></td>
                <td><?php echo $w2 = $allwanita['nomayor']['2']['jumlah'] - $jumw2;?></td>
                <td><?php echo $s2 = $p2 + $w2;?></td>  
                <td><?php echo $p3 = $allpria['nomayor']['3']['jumlah'] - $jump3;?></td>
                <td><?php echo $w3 = $allwanita['nomayor']['3']['jumlah'] - $jumw3;?></td>
                <td><?php echo $s3 = $p3 + $w3;?></td>
                <td><?php echo ($s2 + $s3);?></td>
            </tr>
            </tbody>
     ...
     <div class="row">
    <div class="col-lg-12" >
    <h3>Rekap Data Per Fakultas (Masuk Pleno)</h3>
        <table style="width:100%;" class='table' id='rekapfak'>
            <thead>
                <tr>
                    <th rowspan="3">No</th>
                    <th rowspan="3">Fakultas</th>
                    <th colspan="7">Periode 1</th>
                    <th colspan="7">Periode 2</th>
            ...
            <tr>
                <td><?php echo $no;?></td>
                <td><?php echo $fak['inisial'];?></td>
                <td><?php echo $p2 = $pria[$fak['inisial']]['2']['pleno1'];?></td>
                <td><?php echo $w2 = $wanita[$fak['inisial']]['2']['pleno1'];?></td>
                <td><?php echo $s2 = $p2 + $w2;?></td>  
                <td><?php echo $p3 = $pria[$fak['inisial']]['3']['pleno1'];?></td>
                <td><?php echo $w3 = $wanita[$fak['inisial']]['3']['pleno1'];?></td>
                <td><?php echo $s3 = $p3 + $w3;?></td>
                <td><?php echo ($s2 + $s3);?></td>
                <!-- Masuk Pleno -->
                <td><?php echo $p2p = $pria[$fak['inisial']]['2']['pleno2'];?></td>
                <td><?php echo $w2p = $wanita[$fak['inisial']]['2']['pleno2'];?></td>
                <td><?php echo $s2p = $p2p + $w2p;?></td>  
                <td><?php echo $p3p = $pria[$fak['inisial']]['3']['pleno2'];?></td>
                <td><?php echo $w3p = $wanita[$fak['inisial']]['3']['pleno2'];?></td>
            ...
            <tfoot>
                ...
                <td></td>
                <td><strong>Jumlah</strong></td>
                <td><strong><?php echo $p2 = $jump2;?></strong></td>
                <td><strong><?php echo $w2 = $jumw2;?></strong></td>
                <td><strong><?php echo $s2 = $p2 + $w2;?></strong></td>
                <td><strong><?php echo $p3 = $jump3;?></strong></td>
                <td><strong><?php echo $w3 = $jumw3;?></strong></td>
                <td><strong><?php echo $s3 = $p3 + $w3;?></strong></td>  
                <td><strong><?php echo ($s2 + $s3);?></strong></td>
                <!-- Masuk Pleno -->
