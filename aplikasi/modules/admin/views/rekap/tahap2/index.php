...
<div class="box box-default color-palette-box">
               <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-tag"></i> Pendaftar T.A. <?=$tahunakademik?> Yang Sudah Melakukan Verifikasi PIN Periode Pendaftaran Tahap 2</h3>
            </div>
    ...
    <?php
        ...
        foreach ($fakultas as $f){
           ...
           foreach($jums2 as $s2){
                ...
                if($s2['orang']['jenisKelamin']==1 && $s2['verifikasiPMB'] ==1 && ( $s2['paketPendaftaran']['title'] =='Tahap 2' &&  $tahap_sidang =='Tahap 2' )){
                    $pria[$f['inisial']]['2']['jumlah'] += 1;
                    $pria[$f['inisial']]['2']['pleno2'] += 1;
                }elseif($s2['orang']['jenisKelamin']==1 && (($s2['verifikasiPMB'] ==1 && $s2['paketPendaftaran']['title']=='Kelas Khusus') || $s2['verifikasiPMB'] ==0 || $s2['verifikasiPMB'] ==2 || empty($s2['verifikasiPMB']))){
                    $pria[$f['inisial']]['2']['jumlah'] += 1;
                }elseif($s2['orang']['jenisKelamin']==0 && $s2['verifikasiPMB'] ==1 && ($s2['paketPendaftaran']['title'] =='Tahap 2' &&  $tahap_sidang =='Tahap 2' )){
                    $wanita[$f['inisial']]['2']['jumlah'] += 1;
                    $wanita[$f['inisial']]['2']['pleno2'] += 1;
                }elseif($s2['orang']['jenisKelamin']==0 && (($s2['verifikasiPMB'] ==1 && $s2['paketPendaftaran']['title']=='Kelas Khusus') || $s2['verifikasiPMB'] ==0 || $s2['verifikasiPMB'] ==2 || empty($s2['verifikasiPMB']))){
                    $wanita[$f['inisial']]['2']['jumlah'] += 1;
                }
           }
           ...
           foreach($jums3 as $s3){
                ...
                if($s3['orang']['jenisKelamin']==1 && $s3['verifikasiPMB'] ==1 && (($s3['paketPendaftaran']['title'] =='Tahap 1' &&  $tahap_sidang =='Tahap 2') || ($s3['paketPendaftaran']['title'] =='Tahap 2' &&  $tahap_sidang =='Tahap 2') )){
                    $pria[$f['inisial']]['3']['jumlah'] += 1;
                    $pria[$f['inisial']]['3']['pleno2'] += 1;
                }elseif($s3['orang']['jenisKelamin']==1 && (($s3['verifikasiPMB'] ==1 && $s3['paketPendaftaran']['title']=='Kelas Khusus') || $s3['verifikasiPMB'] ==0 || $s3['verifikasiPMB'] ==2 || empty($s3['verifikasiPMB']))){
                    $pria[$f['inisial']]['3']['jumlah'] += 1;
                }elseif($s3['orang']['jenisKelamin']==0 && $s3['verifikasiPMB'] ==1 && (($s3['paketPendaftaran']['title'] =='Tahap 1' &&  $tahap_sidang =='Tahap 2') || ($s3['paketPendaftaran']['title'] =='Tahap 2' &&  $tahap_sidang =='Tahap 2') )){
                    $wanita[$f['inisial']]['3']['jumlah'] += 1;
                    $wanita[$f['inisial']]['3']['pleno2'] += 1;
                }elseif($s3['orang']['jenisKelamin']==0 && (($s3['verifikasiPMB'] ==1 && $s3['paketPendaftaran']['title']=='Kelas Khusus') || $s3['verifikasiPMB'] ==0 || $s3['verifikasiPMB'] ==2 || empty($s3['verifikasiPMB']))){
                    $wanita[$f['inisial']]['3']['jumlah'] += 1;
                }
           }
        ...
        foreach ($fakultas as $f){
           ...
           foreach($jums2 as $s2){
                $tahap_sidang = isset($s2->pendaftaranHasProgramStudis[0]->prosesSidangs[0]->sidang->paketPendaftaran->title)? $s2->pendaftaranHasProgramStudis[0]->prosesSidangs[0]->sidang->paketPendaftaran->title : '';
                if($s2['orang']['jenisKelamin']==1 && $s2['verifikasiPMB'] ==1 && ($s2['paketPendaftaran']['title'] =='Tahap 1' &&  $tahap_sidang =='Tahap 2')){
                    $pria[$f['inisial']]['2']['pleno1'] += 1;
                }elseif($s2['orang']['jenisKelamin']==0 && $s2['verifikasiPMB'] ==1 && ($s2['paketPendaftaran']['title'] =='Tahap 1' &&  $tahap_sidang =='Tahap 2')){
           ...
           foreach($jums3 as $s3){
                $tahap_sidang = isset($s3->pendaftaranHasProgramStudis[0]->prosesSidangs[0]->sidang->paketPendaftaran->title)? $s3->pendaftaranHasProgramStudis[0]->prosesSidangs[0]->sidang->paketPendaftaran->title : '';
                if($s3['orang']['jenisKelamin']==1 && $s3['verifikasiPMB'] ==1 && ($s3['paketPendaftaran']['title'] =='Tahap 1' &&  $tahap_sidang =='Tahap 2')){
                    $pria[$f['inisial']]['3']['pleno1'] += 1;
                }elseif($s3['orang']['jenisKelamin']==1 && $s3['verifikasiPMB'] ==1 && ($s3['paketPendaftaran']['title'] =='Tahap 1' &&  $tahap_sidang =='Tahap 2')){
    ...
    'items' => [
        [
            'label' => 'Tabel',
            'content' => Yii::$app->controller->renderPartial('tahap2/rekap', ['pria'=>$pria, 'wanita'=>$wanita, 'allpria'=>$allpria, 'allwanita'=>$allwanita, 'fakultas'=>$fakultas]),
            'active' => true
        ],
        [
            'label' => 'Grafik',
            'content' => Yii::$app->controller->renderPartial('tahap2/chart2', ['faks2' => $faks2, 'faks3' => $faks3, 'fak' => $fak]),
            'headerOptions' => ['style'=>''],
