...
use app\modules\verifikasi\models\Absenm5Form;
...
class Absenm5Controller extends \yii\web\Controller
{
    public function actionIndex()
    {
        $absenm5Form = new Absenm5Form();

        $absenm5Form->addForm(Yii::$app->request->queryParams);

        return $this->render('index', [
            'absenm5Form' => $absenm5Form,
        ]);
    }

    public function actionKuliahumum()
    {
        $absenm5Form = new KuForm();
