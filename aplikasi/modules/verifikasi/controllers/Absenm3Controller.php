...
use app\modules\verifikasi\models\Absenm3Form;
...
class Absenm3Controller extends \yii\web\Controller
{
    public function actionIndex()
    {
        $absenm3Form = new Absenm3Form();

        $absenm3Form->addForm(Yii::$app->request->queryParams);

        return $this->render('index', [
            'absenm3Form' => $absenm3Form,
        ]);
    }

    public function actionKuliahumum()
    {
        $absenm3Form = new KuForm();
